...
const config = {  
  minViewerCount: 33, // mininum number of viewers for bot to be active
  gamblingEnabled: true, // Enable/disable gambling all together (wil still respond to duels)
  offlineGambling: false, // Enable/disable offline gambling
  ...
  minMessageIntervalOffline: 80.5, // min minutes between messages sent when offline
  maxMessageIntervalOffline: 100.5, // max minutes between message sent when offline

  startSlots: false, // Set to true if you want to start slots, or false to disable it
  slotMessage: '!slots all',
  slotMessageInterval: 17, // Interval in minutes for sending the slot message
